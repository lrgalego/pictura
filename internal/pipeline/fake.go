...
var looks = []CharacterSpec{
	...
	{Role: "supporting", Age: "forties", Visual: "Broad-shouldered with a sunburnt face, a grey-streaked beard and a permanent squint from years at sea.", Wardrobe: "A navy fisherman's sweater, oilskin trousers, a knitted cap.", Items: "A coil of rope over one shoulder.", Personality: "Gruff and slow to trust. Arms crossed, chin down."},
	{Role: "comic relief", Age: "unknown", Visual: "A scruffy terrier with one ear up, one ear down, wiry brown fur and enormous eyebrows.", Wardrobe: "A red bandana.", Items: "Half a sausage, always.", Personality: "Suspicious of everyone until fed."},
	{Role: "supporting", Age: "thirties", Visual: "Tall and languid with olive skin, a shaved head, hooded eyes and a small gold ring in one ear.", Wardrobe: "A long camel coat over a black turtleneck, leather gloves.", Items: "A lockpick set in a cigarette case.", Personality: "Unbothered by anything. Leans on things."},
}
